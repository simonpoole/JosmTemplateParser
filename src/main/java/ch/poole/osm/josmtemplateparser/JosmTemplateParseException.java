 ...
 */
public class JosmTemplateParseException extends ParseException {
    ...
    JosmTemplateParseException(String message) {
        this(message, -1, -1);
    }

    JosmTemplateParseException(String message, @Nullable Token token) {
        this(message, token != null ? token.beginLine : -1, token != null ? token.beginColumn : -1);
    }

    private JosmTemplateParseException(String message, int line, int column) {
        super(message);
        this.line = line;
        this.column = column;
    }

    JosmTemplateParseException(ParseException ex) {
